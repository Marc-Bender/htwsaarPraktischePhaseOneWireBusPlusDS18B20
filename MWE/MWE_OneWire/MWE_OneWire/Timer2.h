...
/***
 *** Enthält die Definitionen für den Umgang mit Timer2. Weitestgehend identisch mit timer0 der daher unerklärt bleibt. 
 *** Hauptunterschied liegt in den Verfügbaren Prescalern. Timer2 hat einen Prescaler mehr als Timer0.
 *** Die Funktionalität für das generieren von interrupts nach einer fixen zeit ist cpu takt frequenz abhängig und hardcoded mit der annahme von einem 16mhz takt. 
 *** Es wurde keine funktionalität für das berechnen der entsprechenden werte zur laufzeit implementiert. Dies wurde in einem anderen projekt gemacht und hatte einen respektablen batzen code
 *** zur folge. Im übrigen ist es nicht zielführend die ewig gleichen werte jedes mal aufs neue zu berechnen.
***/
...
/***
 *** Zählt die Konfigurationsmodi für Timer2 auf. Wird gebraucht um die WGM bits zu konfigurieren. 
***/
typedef enum
{
...
/***
 *** Zählt die verschiedenen Prescaler von Timer2 auf. 
***/
typedef enum
{
