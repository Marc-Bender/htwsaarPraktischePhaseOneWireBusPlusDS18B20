/***
 *** Definitionen für die verwendung von gpio pins 
 *** keine der funktionen in diesem modul testen ob die daten in den entsprechenden datenstrukturen sinnvoll sind (z.b das ein pin im portb nur register von portb besitzt)
 *** es steht in der verantwortung des nutzers sicher zustellen, dass in den datenstrukturen sinnvoller inhalt steht. (Garbage in -> garbage out prinzip)ä
***/
/**
 * \file "GPIO Pin.h"
