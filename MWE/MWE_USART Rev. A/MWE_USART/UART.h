...
**/
/***
 *** Definitionen für die arbeit mit dem usart. nur usart0 ist derzeit implementiert, nur der Transmitter ist implementiert. Übertragungen sind interrupt getrieben. Daten werden in einem ring buffer gehalten.
***/
...
#define UART_H_
	...
	/***
	 *** Listet die verschiedenen möglichen Baudraten auf.
	***/
	typedef enum
	{
		USARTBaudRate_Reset,
