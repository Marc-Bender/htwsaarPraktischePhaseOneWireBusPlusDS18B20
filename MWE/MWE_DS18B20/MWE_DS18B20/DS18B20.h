...
**/ 
/***
 *** enthält die definitionen für das arbeiten mit ds18b20 temperatursensoren zumindest zu dem maß das für die applikation erforderlich war.
 *** enthält auch funktionen zum zerlegen vom 7.4 fixed point datenformat in einzelteile die später leicht in ein float, einen String, ... zusammengesetzt werden können.
***/
#ifndef DS18B20_H_
#define DS18B20_H_
