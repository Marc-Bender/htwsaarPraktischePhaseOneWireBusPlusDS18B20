...
# 13 ".././marcsLanguageExtension.c"
void deathTrap(void)
{
 
# 15 ".././marcsLanguageExtension.c" 3
__asm__ __volatile__ ("cli" ::: "memory")
# 15 ".././marcsLanguageExtension.c"
     ;
 for(;;)
  ;
}
