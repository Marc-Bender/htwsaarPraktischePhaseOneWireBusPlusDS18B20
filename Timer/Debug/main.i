...
void setWaveformGenerationModeTimer0( const WaveformGenerationModeTimer0_t waveformmode);
void setPrescalerTimer0( const PrescalerTimer0_t prescaler);
void enableTimer0OverflowInterrupt(void);
void stopTimer0(void);
void defineCallbackOnTimer0Overflow( const CallbackFunctionType callbackFunction);
void enableTimer0CaptureCompareAInterrupt(void);
void defineCallbackOnTimer0CaptureCompareAMatch( const CallbackFunctionType callbackFunction);
...
const uint8_t deviceID0[(8U)]={0x28, 0x7e, 0xa0, 0xbc, 0x05, 0x00, 0x00, 0x10};
const uint8_t deviceID1[(8U)]={0x28, 0xA0, 0xC9, 0xC3, 0x03, 0x00, 0x00, 0xC6};
const uint8_t deviceID2[(8U)]={0x28, 0xA8, 0xB0, 0xC3, 0x03, 0x00, 0x00, 0xF9};
const uint8_t deviceID3[(8U)]={0x28, 0x04, 0xDE, 0xC3, 0x03, 0x00, 0x00, 0x6B};
const uint8_t deviceID4[(8U)]={0x28, 0x0C, 0xBF, 0xC3, 0x03, 0x00, 0x00, 0x16};
const uint8_t deviceID5[(8U)]={0x28, 0xCC, 0x9E, 0xC3, 0x03, 0x00, 0x00, 0xBC};
const uint8_t deviceID6[(8U)]={0x28, 0x9E, 0xAD, 0xC3, 0x03, 0x00, 0x00, 0x36};
const uint8_t deviceID7[(8U)]={0x28, 0x3E, 0xD0, 0xC3, 0x03, 0x00, 0x00, 0xEB};
const uint8_t deviceID8[(8U)]={0x28, 0x71, 0xF3, 0x9B, 0x03, 0x00, 0x00, 0xC8};
const uint8_t deviceID9[(8U)]={0x28, 0x93, 0xAD, 0xC3, 0x03, 0x00, 0x00, 0x7C};

const uint8_t deviceIDThermocouple[(8U)]={0x3B, 0x19, 0x2B, 0x18, 0x00, 0x00, 0x00, 0xC3};



const uint8_t * deviceIDs[(11U)]={deviceIDThermocouple,deviceID0,deviceID1,deviceID2,deviceID3,deviceID4,deviceID5,deviceID6,deviceID7,deviceID8,deviceID9};

volatile uint8_t idByte=0;
signed7Point4Fixed_t currentTemperatures[(11U)]={0};
...
{
 static uint16_t remainingNumberOfInterruptsForOneSecond = (2000UL);

 if(remainingNumberOfInterruptsForOneSecond == 0)
 {
  remainingNumberOfInterruptsForOneSecond = (2000UL);
...
void sendTelemetryViaUSART0(void)
{
 ...
 if (deviceIDs[indexOfTemperatureSensorBeingRead][0]==(0x28))
 {
 ...
 else if(deviceIDs[indexOfTemperatureSensorBeingRead][0]==(0x3B))
 {
...
{
 if(indexOfTemperatureSensorBeingRead<(11U)-1)
 {
...
{
 issueTemperatureConversion(&onewirepin,
# 126 ".././main.c" 3 4
                                       0
# 126 ".././main.c"
                                            ,deviceIDs[indexOfTemperatureSensorBeingRead], &onTemperatureConversionStarted);
}

void startTemperatureConversionAndReadoutCycle(void)
{

 errorBits[indexOfTemperatureSensorBeingRead]=
# 132 ".././main.c" 3 4
                                             1
# 132 ".././main.c"
                                                 ;
...
__attribute__((constructor)) void mainInit(void)
{
 ...
 telemetryString = malloc((sizeof('#')+2+sizeof(':')+1+3+sizeof('.')+4+strlen("degC ")+strlen("Err: ")+1+strlen("\r\n")+sizeof('\0')));
 uptimeString = malloc((strlen("!!Uptime [s]= ")+10+strlen(" \r\n")));
