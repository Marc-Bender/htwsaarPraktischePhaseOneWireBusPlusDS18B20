...
void sendID( const 
# 21 ".././OneWireFrontEnd.c" 3 4
                        _Bool 
# 21 ".././OneWireFrontEnd.c"
                             startAtZero);

void sendNextIDByte(void)
{
 sendID(
# 25 ".././OneWireFrontEnd.c" 3 4
       0
# 25 ".././OneWireFrontEnd.c"
            );
}

void sendID( const 
# 28 ".././OneWireFrontEnd.c" 3 4
                        _Bool 
# 28 ".././OneWireFrontEnd.c"
                             startAtZero)
{
 ...
 if(startAtZero)
  positionWithinID=0;
 if (positionWithinID<(8U))
  writeByteToOneWireBus(internalDataOneWireFrontend.deviceId[positionWithinID++],
# 35 ".././OneWireFrontEnd.c" 3 4
                                                                                1
# 35 ".././OneWireFrontEnd.c"
                                                                                    ,internalDataOneWireFrontend.onewirepin,&sendNextIDByte);
 else
...
{
 sendID(
# 42 ".././OneWireFrontEnd.c" 3 4
       1
# 42 ".././OneWireFrontEnd.c"
           );
}

void onReadyToSendMatchRomCommand(void)
{
 writeByteToOneWireBus(OneWireRomCommands_MatchRom,
# 47 ".././OneWireFrontEnd.c" 3 4
                                                  1
# 47 ".././OneWireFrontEnd.c"
                                                      ,internalDataOneWireFrontend.onewirepin, &onMatchRomCommandSent);
}

void onReadyToSendSkipRomCommand(void)
{
 writeByteToOneWireBus(OneWireRomCommands_SkipRom,
# 52 ".././OneWireFrontEnd.c" 3 4
                                                 1
# 52 ".././OneWireFrontEnd.c"
                                                     ,internalDataOneWireFrontend.onewirepin, internalDataOneWireFrontend.callback);
}

__attribute__((optimize("O3"))) void sendMatchRomCommand( const GPIOPin_t * const onewirepin, const uint8_t * const deviceID, const CallbackFunctionType onMatch)
{
...
# 74 ".././OneWireFrontEnd.c" 3 4
                       ((void *)0)
# 74 ".././OneWireFrontEnd.c"
                           , 
# 74 ".././OneWireFrontEnd.c" 3 4
                             0
# 74 ".././OneWireFrontEnd.c"
...
# 77 ".././OneWireFrontEnd.c" 3 4
                                                                                           _Bool 
# 77 ".././OneWireFrontEnd.c"
                                                                                                startAtZero, const GPIOPin_t * const onewirepin, const CallbackFunctionType onByteRead)
{
 ...
 static 
# 83 ".././OneWireFrontEnd.c" 3 4
       _Bool 
# 83 ".././OneWireFrontEnd.c"
            readBit;
...
# 109 ".././OneWireFrontEnd.c" 3 4
                         0
# 109 ".././OneWireFrontEnd.c"
                              , 
# 109 ".././OneWireFrontEnd.c" 3 4
                                ((void *)0)
# 109 ".././OneWireFrontEnd.c"
...
# 112 ".././OneWireFrontEnd.c" 3 4
                                                                                                  _Bool 
# 112 ".././OneWireFrontEnd.c"
                                                                                                       startAtZero, const GPIOPin_t * const onewirepin, const CallbackFunctionType onByteSent)
{
