...
volatile 
# 15 ".././OneWireLowLevel.c" 3 4
        _Bool 
# 15 ".././OneWireLowLevel.c"
             isDevicePresent=
# 15 ".././OneWireLowLevel.c" 3 4
                             0
# 15 ".././OneWireLowLevel.c"
...
void readBitFromOneWire( const GPIOPin_t * const onewirepin, 
# 23 ".././OneWireLowLevel.c" 3 4
                                                                          _Bool 
# 23 ".././OneWireLowLevel.c"
                                                                               * const storeReadBitHere, const CallbackFunctionType onBitRead)
{
...
# 106 ".././OneWireLowLevel.c" 3 4
_Bool 
# 106 ".././OneWireLowLevel.c"
     isEdgeFalling=
# 106 ".././OneWireLowLevel.c" 3 4
                   0
# 106 ".././OneWireLowLevel.c"
...
# 110 ".././OneWireLowLevel.c" 3 4
                               0
# 110 ".././OneWireLowLevel.c"
                                    )
   isEdgeFalling = 
# 111 ".././OneWireLowLevel.c" 3 4
                  1
# 111 ".././OneWireLowLevel.c"
                      ;
 }
...
{
 isDevicePresent=
# 126 ".././OneWireLowLevel.c" 3 4
                0
# 126 ".././OneWireLowLevel.c"
                     ;
 internalData.onewirepin = onewirepin;
