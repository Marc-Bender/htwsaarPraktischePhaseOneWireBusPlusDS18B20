...
void onScratchpadRead(void)
{
  ...
  *(internalDataReadTemperatureDS18B20.errorBit) = 
# 61 ".././DS18B20.c" 3 4
                                                  1
# 61 ".././DS18B20.c"
                                                      ;
...
void readScratchpadRegisters( const 
# 67 ".././DS18B20.c" 3 4
                                         _Bool 
# 67 ".././DS18B20.c"
                                              startAtZero);
                                              ...
                                              startAtZero)
{
 ...
 if(positionWithinScratchpad<sizeof(struct scratchpadAsStruct))
  readByteFromOneWireBus(&internalDataReadSP_DS18B20.scratchpad->asArray[positionWithinScratchpad++],
# 80 ".././DS18B20.c" 3 4
                                                                                                    1
# 80 ".././DS18B20.c"
                                                                                                        ,internalDataReadSP_DS18B20.onewirepin,&readNextScratchpadByte);
 else
  onScratchpadRead();
}
...
{
 writeByteToOneWireBus(DS18B20_ROMCommands_ReadScratchpad,
# 92 ".././DS18B20.c" 3 4
                                                         1
# 92 ".././DS18B20.c"
                                                             ,internalDataReadSP_DS18B20.onewirepin,&onReadScratchpadCommandSent);
}

void readEntireScratchpad( const GPIOPin_t * const onewirepin, const uint8_t * const deviceID, DS18B20_Scratchpad_t * const scratchpadThatContainsTheRawData, const CallbackFunctionType onEntireScratchpadRead)
{
 ...
 *(internalDataReadTemperatureDS18B20.temperatureFixedPointFormat) = (internalDataReadSP_DS18B20.scratchpad->asStruct.temperatureMSB<<8) | internalDataReadSP_DS18B20.scratchpad->asStruct.temperatureLSB;;
 ...
 free(internalDataReadSP_DS18B20.scratchpad);
 internalDataReadSP_DS18B20.scratchpad=
# 111 ".././DS18B20.c" 3 4
                                      ((void *)0)
# 111 ".././DS18B20.c"
                                          ;
 internalDataReadTemperatureDS18B20.callback();
}
...
{
 writeByteToOneWireBus(DS18B20_ROMCommands_ConvertTemperature,
# 122 ".././DS18B20.c" 3 4
                                                             1
# 122 ".././DS18B20.c"
                                                                 ,internalDataReadTemperatureDS18B20.onewirepin,&onConvertTemperatureCommandSent);
}
                                                                                                                                                                                     ...
                                                                                                                                                                                     * const errorBit, const CallbackFunctionType onTemperatureReady)
{
 ...
 DS18B20_Scratchpad_t * scratchpadForReadingTemps = malloc(sizeof(DS18B20_Scratchpad_t));
 if(scratchpadForReadingTemps==
# 148 ".././DS18B20.c" 3 4
                              ((void *)0)
# 148 ".././DS18B20.c"
                                  )
